...
ggsave("Group9_Aim3_Core_UPDRS_Male_Venn.png", venn_updrs_male, bg = "white")
...
ggsave("Group9_Aim3_Core_UPDRS_Male_Venn_2.png", venn_updrs_male_2, bg = "white")
...
ggsave("Group9_Aim3_Core_UPDRS_Female_Venn.png", venn_updrs_female, bg = "white")
...
ggsave("Group9_Aim3_Core_UPDRS_AllGroups_Venn.png", venn_updrs_all, bg = "white")
...
ggsave("Group9_Aim3_Core_UPDRS_AllGroups_Venn_2.png", venn_updrs_all_2, bg = "white")
...
ggsave("Group9_Aim3_Core_MoCA_Male_Venn.png", venn_moca_male, bg = "white")
...
ggsave("Group9_Aim3_Core_MoCA_Female_Venn.png", venn_moca_female, bg = "white")
...
print(venn_moca_all)
ggsave("Group9_Aim3_Core_MoCA_AllGroups_Venn.png", venn_moca_all, bg = "white")
...
run_isa <- function(ps_obj, group_col, filename_csv, filename_plot,
  ...
  if (nrow(results_df) > 0) {
    ...
    print(isa_plot)
    ggsave(filename_plot, isa_plot, bg = "white", width = 10, height = 7, dpi = 300)
...
run_deseq2 <- function(ps_obj, group_col, contrasts, filename_prefix) {
  ...
  for (contrast in contrasts) {
    ...
    ggsave(paste0(filename_prefix, "_", safe_name, ".png"),
           bar_plot, bg = "white", width = 10, height = 7, dpi = 300)
...
################################ Combined Heatmap ################################ 
  ...
  if (length(all_sig_ASVs) > 0) {
    ...
    print(heatmap)
    ggsave(paste0(filename_prefix, "_Heatmap.png"), heatmap, bg = "white",
           width = 10,
           height = max(6, length(all_sig_ASVs) * 0.3 + 2),
           dpi = 300)
  }
...
run_isa(
  ...
  filename_csv  = "Group9_Aim3_ISA_UPDRS_Results.csv",
  filename_plot = "Group9_Aim3_ISA_UPDRS_Plot.png",
...
run_deseq2(
  ...
  filename_prefix = "Group9_Aim3_DESeq2_UPDRS"
)
...
run_isa(
  ...
  filename_csv  = "Group9_Aim3_ISA_MoCA_Results.csv",
  filename_plot = "Group9_Aim3_ISA_MoCA_Plot.png",
...
run_deseq2(
  ...
  filename_prefix = "Group9_Aim3_DESeq2_MoCA"
)
